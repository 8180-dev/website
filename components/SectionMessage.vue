<template>
  <section class="section-message">
    <div class="sm__title">
      <TitleLevel3 :variation="`message`" />
    </div>

    <div class="sm__logo">
      <svg viewBox="0 0 315.69 141.61">
        <title>logo</title>
        <g>
          <path
            class="a"
          ...
          <path
            class="a"
            d="M218.35,113.14a3,3,0,0,0-2.95,3h0a3,3,0,1,0,2.95-3Z"
          />
          <path
            class="a"
            d="M209.07,113.14a3,3,0,0,0-2.95,3h0a3,3,0,1,0,2.95-3Z"
          />
          <path
            class="a"
    ...
    <div class="sm__text" v-html="postJson.message" />
  </section>
</template>

<script>
import TitleLevel3 from '~/components/TitleLevel3'
